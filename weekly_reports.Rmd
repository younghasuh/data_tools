...
nodes_list <- unique(health_df$NodeId)
...
mynodes <- node_plots(health_data, nodes_list, freq_node)
mynodes[[1]]
...
tides = FALSE
export_node_plots(health = health_data, freq = freq_node, out_path = "/plots", x = 5,y = 4, z = 1)
